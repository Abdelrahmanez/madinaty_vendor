...
const RestaurantVendorNavigator = () => {
  ...
  return (
    ...
    >
      <Tab.Screen name="RestaurantTab" component={RestaurantNavigator} options={{ title: 'المطعم' }} />
...
export default RestaurantVendorNavigator;
